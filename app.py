...
# Determine the running mode. whether to show metrics
# - ALL in 'one' chart (one), or
# - Each metric on it's own Chart (multiple)
...
if mode == 'one':
    ...
    def update_combined_graph(n):
        ...
        current_time = datetime.now().strftime(
            '%H:%M:%S')  # Get the current time as a string
